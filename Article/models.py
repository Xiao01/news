...
class Category(models.Model):
    title = models.CharField(max_length=20,verbose_name='大类')
...
class Item(models.Model):
    title = models.CharField(max_length=20,verbose_name='子类',
                             help_text="子类")
    ...
    categorys = models.ForeignKey(Category,on_delete=models.CASCADE,related_name='大类',help_text="大类")
...
class Article(models.Model):
    ...
    author = models.ForeignKey(User,related_name='auhor',on_delete=models.CASCADE,
    ...
    item = models.ForeignKey(Item,related_name='item',on_delete=models.CASCADE,verbose_name='子类',help_text='子类')
    pic = models.ImageField(upload_to='upload/',verbose_name='图片',help_text='图片')
...
class Ad(models.Model):
    ...
    pic = models.ImageField(upload_to='upload/',verbose_name='广告图',help_text='广告图')
    adurl = models.URLField(verbose_name='地址',help_text='地址')
    adlocation = models.CharField(max_length=2,verbose_name='位置',help_text='位置')#a1,a2,a3
